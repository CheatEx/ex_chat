...
if config_env() != :dev do
  ...
  database_use_ssl =
    (System.get_env("DATABASE_USE_SSL") ||
       raise("""
       environment variable DATABASE_USE_SSL is missing.
       """))
    |> String.trim()
    |> String.downcase()
    |> (&(&1 == "true")).()
  ...
  config :ex_chat, ExChat.Guardian, secret_key: jwt_secret_key
end
